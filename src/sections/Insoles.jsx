      ...
      <div className="max-w-6xl w-full mx-auto flex flex-col items-center">
        ...
        <div className="text-center max-w-2xl mb-16 space-y-3">
          ...
          <p className="text-xs sm:text-sm text-gray-500 font-medium tracking-wide">
            Unparalleled comfort and support through innovative insole technology.
          </p>
        </div>
          ...
          <div className="lg:col-span-8 bg-white p-6 sm:p-10 border border-gray-100 shadow-xl shadow-gray-200/40 flex flex-col sm:flex-row items-center gap-8 rounded-none">
            ...
            <div className="w-full sm:w-1/2 flex flex-col justify-center space-y-4">
              ...
              <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
                We strive to enhance the well-being of our customers by offering products that improve posture and reduce foot pain through physical engineering.
              </p>
            </div>
          </div>
